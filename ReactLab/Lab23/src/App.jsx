...
import golubImage from "./assets/golub.png";

function AppContent() {
    const dispatch = useDispatch();
    const { isLoggedIn, userName, isAdmin, isBlocked } = useSelector(
        (state) => state.auth
    );
                                        ...
                                        <div className="container mt-4">
                                            <ol className="list-group list-group-numbered">
                                                <li className="list-group-item py-3">
                                                    ...
                                                    React-hook-forms или Formik
                                                    (валидация полей)
                                                </li>
                                                <li className="list-group-item py-3">
                                                    Реализовать блок обратной
                                                    связи. Форма обратной связи
                                                    и список отзывов
                                                </li>
                                                <li className="list-group-item py-3">
                                                    Обработать submit форм через
                                                    useCallback функции по
                                                    примеру Лабораторной работы
                                                    1
                                                </li>
                                                <li className="list-group-item py-3">
                                                ...
                                                <li className="list-group-item py-3">
                                                    Хранить статус авторизации
                                                    можно в redux, context или
                                                    localStore
                                                </li>
                                                <li className="list-group-item py-3">
                                                    Реализовать в правом верхнем
                                                    углу профиль пользователя с
                                                    кнопкой разлогина
                                                </li>
                                            </ol>
                                        </div>
